  ...
  <div class="w-80 border-r border-sidebar-border bg-sidebar h-screen flex flex-col">
    <div class="p-4 border-b border-sidebar-border">
      ...
      <div class="relative mb-2">
        ...
        <Input v-model="searchQuery" placeholder="Search endpoints..." class="pl-8 h-9 text-sm" autocomplete="off"
          data-lpignore="true" data-1p-ignore="true" data-form-type="other" type="search" />
      </div>
    ...
    <ScrollArea class="flex-1">
      <div class="p-2">
        <div v-if="root.name === 'root'">
          ...
          <div
            v-if="(searchQuery || securityFilter !== 'all' || selectedMethods.size < availableMethods.length) && filteredRootChildren.length === 0"
